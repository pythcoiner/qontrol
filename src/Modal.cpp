...
Modal::Modal(const QString &title, const QString &msg) {
    ...
    auto *btnRow = (new qontrol::Row)->pushSpacer()->push(btn)->pushSpacer();

    auto *labelRow = (new qontrol::Row)->pushSpacer()->push(label)->pushSpacer();
    col->pushSpacer()->push(labelRow)->pushSpacer()->push(btnRow)->pushSpacer(10);
