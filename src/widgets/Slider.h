...
public:
  ...
  static auto percent(const QString &label, int label_width, QWidget *parent = nullptr, int *travel_allowed = nullptr) -> Slider*;
  static auto cursor(const QString &left_label, int left_label_width, const QString &right_label, int right_label_width, QWidget *parent ) -> Slider*;
  static auto axis(const QString &axis_name, int label_width, QList<int> ticks, bool optional, bool linear, QWidget *parent ) -> Slider*;
